...
const getProductById = (req, res) => {
    ...
    /*a la variable de const la pongo entre llaves porque de toda la informacion que contiene params, a mi solamente me interesa su propiedad llamada "productId"*/
    ...
    //lo coloco entre llaves porque lo mostrara en formato json, es decir, espera un formato json
